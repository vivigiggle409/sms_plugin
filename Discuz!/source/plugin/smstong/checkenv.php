...
if(!$h) {
    $result.="<br /><font color='red'>空间不支持访问短信网关，请确保服务器PHP环境能访问外网，Linux的请先配置DNS。</font>";
}
...
<?php } else { ?>
<br /><a href="http://addon.discuz.com/?@smstong.plugin.doc/faq" target="_blank" class="btn">环境检测不通过查看常见问题</a>

...
if($_GET['op'] == 'delete') {
	DB::query("DELETE FROM sms_send WHERE id='$_GET[id]'");
	ajaxshowheader();
...
showsubmit('sendedsubmit', $Plang['smstong_search'], ''.$lang['mobile'].': <input name="srchmobile" value="'.htmlspecialchars(stripslashes($_GET['srchmobile'])).'" class="txt" maxlength="12" />', $searchtext);
...
if(!empty($_GET['exportsendedubmit'])) {

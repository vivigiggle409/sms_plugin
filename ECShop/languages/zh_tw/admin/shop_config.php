...
$_LANG['cfg_name']['ecsdxt'] = 'ECShop短信通設置'; 

$_LANG['cfg_name']['ecsdxt_gateway'] = '短信通道接口'; 
$_LANG['cfg_desc']['ecsdxt_gateway'] = '以下短信功能所用發送短信的通道接口'; 
$_LANG['cfg_range']['ecsdxt_gateway'][1] = 'ECShop  默認通道'; 
$_LANG['cfg_range']['ecsdxt_gateway'][2] = '開源軟件增值服務平台'; 

$_LANG['cfg_name']['ecsdxt_user_name'] = '開源軟件增值服務平台帳號'; 
$_LANG['cfg_desc']['ecsdxt_user_name'] = '請填寫<a href="http://s1.chanyoo.cn/" target="_blank"><font color="red"><b>開源軟件增值服務平台</b></font></a>註冊的帳號'; 
$_LANG['cfg_name']['ecsdxt_pass_word'] = '開源軟件增值服務平台密碼'; 
$_LANG['cfg_desc']['ecsdxt_pass_word'] = '請填寫<a href="http://s1.chanyoo.cn/" target="_blank"><font color="red"><b>開源軟件增值服務平台</b></font></a>帳號的密碼'; 
$_LANG['cfg_name']['ecsdxt_shop_mobile'] = '商家手機號碼'; 
$_LANG['cfg_desc']['ecsdxt_shop_mobile'] = '請填寫商家自己的手機號碼，客戶下訂單以及付款短信提醒'; 
$_LANG['cfg_name']['ecsdxt_smsgap'] = '發送短信間隔';
$_LANG['cfg_desc']['ecsdxt_smsgap'] = '前台用戶請求發送短信時間間隔（單位秒）';

$_LANG['cfg_name']['ecsdxt_mobile_reg'] = '是否開啟手機短信驗證註冊'; 
$_LANG['cfg_desc']['ecsdxt_mobile_reg'] = '開啟後前台用戶註冊頁面必須通過短信驗證手機號才能完成註冊'; 
$_LANG['cfg_name']['ecsdxt_mobile_reg_value'] = '手機短信驗證註冊內容'; 
$_LANG['cfg_desc']['ecsdxt_mobile_reg_value'] = '手機短信驗證註冊發送到註冊用戶手機的短信內容'; 

$_LANG['cfg_name']['ecsdxt_mobile_log'] = '是否開啟手機號登陸'; 
$_LANG['cfg_desc']['ecsdxt_mobile_log'] = '開啟後前台用戶登錄頁面可以通過手機號和密碼登錄網站'; 

$_LANG['cfg_name']['ecsdxt_mobile_pwd'] = '是否開啟手機短信找回密碼'; 
$_LANG['cfg_desc']['ecsdxt_mobile_pwd'] = '開啟後前台找回密碼頁面可以通過輸入手機號短信找回密碼'; 
$_LANG['cfg_name']['ecsdxt_mobile_pwd_value'] = '手機短信找回密碼內容'; 
$_LANG['cfg_desc']['ecsdxt_mobile_pwd_value'] = '手機短信找回密碼發送到找回密碼用戶手機的短信內容'; 

$_LANG['cfg_name']['ecsdxt_mobile_changepwd'] = '是否開啟用戶修改密碼提醒'; 
$_LANG['cfg_desc']['ecsdxt_mobile_changepwd'] = '開啟後前台用戶修改帳號密碼會收到短信提醒'; 
$_LANG['cfg_name']['ecsdxt_mobile_changepwd_value'] = '修改密碼提醒內容'; 
$_LANG['cfg_desc']['ecsdxt_mobile_changepwd_value'] = '修改密碼提醒發送到修改密碼用戶手機的短信內容'; 

$_LANG['cfg_name']['ecsdxt_mobile_bind'] = '是否開啟用戶手機綁定'; 
$_LANG['cfg_desc']['ecsdxt_mobile_bind'] = '開啟後前台用戶登錄網站到用戶中心-用戶信息-個人資料可以（重新）綁定手機號'; 
$_LANG['cfg_name']['ecsdxt_mobile_bind_value'] = '用戶手機綁定內容'; 
$_LANG['cfg_desc']['ecsdxt_mobile_bind_value'] = '用戶綁定手機號發送到用戶手機的短信內容'; 

$_LANG['cfg_name']['ecsdxt_mobile_cons'] = '是否開啟強製手機綁定'; 
$_LANG['cfg_desc']['ecsdxt_mobile_cons'] = '開啟後用戶要下訂單必須先綁定手機號否則提示用戶綁定'; 

$_LANG['cfg_name']['ecsdxt_customer_registed'] = '是否開啟用戶註冊成功短信提示'; 
$_LANG['cfg_name']['ecsdxt_customer_registed_value'] = '用戶註冊成功發送短信內容'; 

$_LANG['cfg_name']['ecsdxt_order_placed'] = '是否開啟客戶下訂單時給商家發送短信'; 
$_LANG['cfg_name']['ecsdxt_order_placed_value'] = '客戶下訂單時給商家發送短信內容'; 

$_LANG['cfg_name']['ecsdxt_order_canceled'] = '是否開啟客戶取消訂單時給商家發送短信'; 
$_LANG['cfg_name']['ecsdxt_order_canceled_value'] = '客戶取消訂單時給商家發送短信內容'; 

$_LANG['cfg_name']['ecsdxt_order_payed'] = '是否開啟客戶付款時給商家發送短信'; 
$_LANG['cfg_name']['ecsdxt_order_payed_value'] = '客戶付款時給商家發送短信內容'; 

$_LANG['cfg_name']['ecsdxt_order_confirm'] = '是否開啟客戶確認收貨時給商家發送短信'; 
$_LANG['cfg_name']['ecsdxt_order_confirm_value'] = '客戶確認收貨時給商家發送短信內容'; 

$_LANG['cfg_name']['ecsdxt_customer_placed'] = '是否開啟客戶下訂單時給客戶發送短信'; 
$_LANG['cfg_name']['ecsdxt_customer_placed_value'] = '客戶下訂單時給客戶發送短信內容'; 

$_LANG['cfg_name']['ecsdxt_customer_canceled'] = '是否開啟客戶取消訂單時給客戶發送短信'; 
$_LANG['cfg_name']['ecsdxt_customer_canceled_value'] = '客戶取消訂單時給客戶發送短信內容'; 

$_LANG['cfg_name']['ecsdxt_customer_payed'] = '是否開啟客戶付款時給客戶發送短信'; 
$_LANG['cfg_name']['ecsdxt_customer_payed_value'] = '客戶付款時給客戶發送短信內容'; 

$_LANG['cfg_name']['ecsdxt_customer_confirm'] = '是否開啟客戶確認收貨時給客戶發送短信'; 
$_LANG['cfg_name']['ecsdxt_customer_confirm_value'] = '客戶確認收貨時給客戶發送短信內容'; 

$_LANG['cfg_name']['ecsdxt_order_picking'] = '是否開啟商家配貨時給客戶發送短信'; 
$_LANG['cfg_name']['ecsdxt_order_picking_value'] = '商家配貨時給客戶發送短信內容'; 

$_LANG['cfg_name']['ecsdxt_order_shipped'] = '是否開啟商家發貨時給客戶發送短信'; 
$_LANG['cfg_name']['ecsdxt_order_shipped_value'] = '商家發貨時給客戶發送短信內容'; 

$_LANG['cfg_range']['ecsdxt_mobile_changepwd']['1'] = '開啟'; 
$_LANG['cfg_range']['ecsdxt_mobile_changepwd']['0'] = '關閉'; 

$_LANG['cfg_range']['ecsdxt_mobile_reg']['1'] = '開啟'; 
$_LANG['cfg_range']['ecsdxt_mobile_reg']['0'] = '關閉'; 

$_LANG['cfg_range']['ecsdxt_mobile_log']['1'] = '開啟'; 
$_LANG['cfg_range']['ecsdxt_mobile_log']['0'] = '關閉'; 

$_LANG['cfg_range']['ecsdxt_mobile_pwd']['1'] = '開啟'; 
$_LANG['cfg_range']['ecsdxt_mobile_pwd']['0'] = '關閉'; 

$_LANG['cfg_range']['ecsdxt_mobile_bind']['1'] = '開啟'; 
$_LANG['cfg_range']['ecsdxt_mobile_bind']['0'] = '關閉'; 

$_LANG['cfg_range']['ecsdxt_mobile_cons']['1'] = '開啟'; 
$_LANG['cfg_range']['ecsdxt_mobile_cons']['0'] = '關閉'; 

$_LANG['cfg_range']['ecsdxt_order_placed']['1'] = '開啟'; 
$_LANG['cfg_range']['ecsdxt_order_placed']['0'] = '關閉'; 

$_LANG['cfg_range']['ecsdxt_order_canceled']['1'] = '開啟'; 
$_LANG['cfg_range']['ecsdxt_order_canceled']['0'] = '關閉'; 

$_LANG['cfg_range']['ecsdxt_order_payed']['1'] = '開啟'; 
$_LANG['cfg_range']['ecsdxt_order_payed']['0'] = '關閉'; 

$_LANG['cfg_range']['ecsdxt_customer_registed']['1'] = '開啟'; 
$_LANG['cfg_range']['ecsdxt_customer_registed']['0'] = '關閉'; 

$_LANG['cfg_range']['ecsdxt_order_confirm']['1'] = '開啟'; 
$_LANG['cfg_range']['ecsdxt_order_confirm']['0'] = '關閉'; 

$_LANG['cfg_range']['ecsdxt_customer_placed']['1'] = '開啟'; 
$_LANG['cfg_range']['ecsdxt_customer_placed']['0'] = '關閉'; 

$_LANG['cfg_range']['ecsdxt_customer_canceled']['1'] = '開啟'; 
$_LANG['cfg_range']['ecsdxt_customer_canceled']['0'] = '關閉'; 

$_LANG['cfg_range']['ecsdxt_customer_payed']['1'] = '開啟'; 
$_LANG['cfg_range']['ecsdxt_customer_payed']['0'] = '關閉'; 

$_LANG['cfg_range']['ecsdxt_customer_confirm']['1'] = '開啟'; 
$_LANG['cfg_range']['ecsdxt_customer_confirm']['0'] = '關閉'; 

$_LANG['cfg_range']['ecsdxt_order_picking']['1'] = '開啟'; 
$_LANG['cfg_range']['ecsdxt_order_picking']['0'] = '關閉'; 

$_LANG['cfg_range']['ecsdxt_order_shipped']['1'] = '開啟'; 
$_LANG['cfg_range']['ecsdxt_order_shipped']['0'] = '關閉';

$_LANG['cfg_name']['ecsdxt_aliyun_appkey'] = '阿裡雲AppKey';
$_LANG['cfg_desc']['ecsdxt_aliyun_appkey'] = '調用阿裡雲市場簡訊介面，阿裡雲創建帳號購買服務後可以到<br />阿裡雲管理控制台-雲市場-已購買的服務裡面找到自己購買服務的AppKey<br />購買簡訊：<a href=“https://market.aliyun.com/products/57126001 /cmapi030182.html”target=“_blank”><font color=“red“><b>阿裡雲市場簡訊介面</b></font></a>，請諮詢QQ:320266360。';

$_LANG['cfg_name']['ecsdxt_aliyun_appsecret'] = '阿裡雲AppSecret';
$_LANG['cfg_desc']['ecsdxt_aliyun_appsecret'] = '調用阿裡雲市場簡訊介面，阿裡雲創建帳號購買服務後可以到<br />阿裡雲管理控制台-雲市場-已購買的服務裡面找到自己購買服務的AppSecret<br />購買簡訊：<a href=“https://market.aliyun.com/products/57126001 /cmapi030182.html”target=“_blank”><font color=“red“><b>阿裡雲市場簡訊介面</b></font></a>，請諮詢QQ:320266360。';
?>
